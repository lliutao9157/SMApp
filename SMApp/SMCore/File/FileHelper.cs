...
namespace SMApp
{
    ...
    class FileHelper
    {
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            StreamWriter sw = new StreamWriter(AppDomain.CurrentDomain.BaseDirectory + dir, false, System.Text.Encoding.GetEncoding("GB2312"));
            sw.Write(pagestr);
            sw.Close();
        }
        /// <summary>
        ...
        public static void MoveFile(string dir1, string dir2)
        {
            dir1 = dir1.Replace("/", "\\");
            dir2 = dir2.Replace("/", "\\");
            if (File.Exists(AppDomain.CurrentDomain.BaseDirectory + dir1))
                File.Move(AppDomain.CurrentDomain.BaseDirectory + dir1, AppDomain.CurrentDomain.BaseDirectory + dir2);
        }
        #endregion
        ...
        public static void CopyFile(string dir1, string dir2)
        {
            ...
            if (File.Exists(AppDomain.CurrentDomain.BaseDirectory + dir1))
            {
                File.Copy(AppDomain.CurrentDomain.BaseDirectory + dir1, AppDomain.CurrentDomain.BaseDirectory + dir2, true);
            }
        }
        #endregion
